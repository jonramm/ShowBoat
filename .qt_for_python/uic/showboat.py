...
"border-radius: 10px;")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.bandBioHeader.setText(QCoreApplication.translate("mainWindow", u"Artist Bio:", None))
        ...
        self.bandBioHeader_2.setText(QCoreApplication.translate("mainWindow", u"Artist Search", None))
#if QT_CONFIG(tooltip)
