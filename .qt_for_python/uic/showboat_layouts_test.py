...
# Form implementation generated from reading ui file 'c:\Users\jrgbo\Documents\repos\ShowBoat\showboat_layouts_test.ui'
#
...
"margin-bottom: .5em;")
        ...
        self.mapMapContainer.setGeometry(QtCore.QRect(9, 59, 1201, 591))
...
"border-radius: 10px;")
        ...
        self.mapMapHeaderLabel.setGeometry(QtCore.QRect(320, 20, 552, 25))
        ...
        self.widget = QtWidgets.QWidget(self.mapTab)
        self.widget.setGeometry(QtCore.QRect(10, 660, 1191, 61))
        self.widget.setObjectName("widget")
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_11.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.mapMapHeaderLabel_2 = QtWidgets.QLabel(self.widget)
        ...
        self.citySearchButton = QtWidgets.QPushButton(self.widget)
        self.citySearchButton.setMinimumSize(QtCore.QSize(120, 0))
...
"color: rgb(200, 47, 101);")
        ...
        self.citySearchInput = QtWidgets.QLineEdit(self.widget)
        ...
        self.citySearchInput.setMinimumSize(QtCore.QSize(300, 0))
        ...
        self.miles25Radio = QtWidgets.QRadioButton(self.widget)
        self.miles25Radio.setObjectName("miles25Radio")
        self.horizontalLayout_11.addWidget(self.miles25Radio)
        self.miles50Radio = QtWidgets.QRadioButton(self.widget)
        self.miles50Radio.setObjectName("miles50Radio")
        self.horizontalLayout_11.addWidget(self.miles50Radio)
        self.miles100Radio = QtWidgets.QRadioButton(self.widget)
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.miles25Radio.setText(_translate("mainWindow", "25 miles"))
